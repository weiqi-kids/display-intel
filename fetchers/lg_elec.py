...
class LgElecFetcher(CompanyFetcher):
    """LG Electronics 爬蟲"""

    company_id = "lg_elec"
    company_name = "LG Electronics"
    news_url = "https://www.lgelectronics.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.lgelectronics.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from LG Electronics")
        return documents
