...
class HimaxFetcher(CompanyFetcher):
    """奇景光電 爬蟲"""

    company_id = "himax"
    company_name = "奇景光電"
    news_url = "https://www.奇景光電.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 奇景光電")
        return documents
