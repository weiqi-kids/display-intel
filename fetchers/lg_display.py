...
class LgDisplayFetcher(CompanyFetcher):
    """LG Display 爬蟲"""

    company_id = "lg_display"
    company_name = "LG Display"
    news_url = "https://www.lgdisplay.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from LG Display")
        return documents
