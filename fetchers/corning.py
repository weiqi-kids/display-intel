...
class CorningFetcher(CompanyFetcher):
    """Corning Incorporated 爬蟲"""

    company_id = "corning"
    company_name = "Corning Incorporated"
    news_url = "https://www.corningincorporated.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.corningincorporated.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Corning Incorporated")
        return documents
