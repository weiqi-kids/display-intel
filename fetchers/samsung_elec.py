...
class SamsungElecFetcher(CompanyFetcher):
    """Samsung Electronics 爬蟲"""

    company_id = "samsung_elec"
    company_name = "Samsung Electronics"
    news_url = "https://www.samsungelectronics.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.samsungelectronics.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Samsung Electronics")
        return documents
