...
class SonyFetcher(CompanyFetcher):
    """Sony Group 爬蟲"""

    company_id = "sony"
    company_name = "Sony Group"
    news_url = "https://www.sonygroup.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.sonygroup.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Sony Group")
        return documents
