...
class CsotFetcher(CompanyFetcher):
    """TCL華星光電 爬蟲"""

    company_id = "csot"
    company_name = "TCL華星光電"
    news_url = "https://www.tcl華星光電.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from TCL華星光電")
        return documents
