...
class RaydiumFetcher(CompanyFetcher):
    """瑞鼎科技 爬蟲"""

    company_id = "raydium"
    company_name = "瑞鼎科技"
    news_url = "https://www.瑞鼎科技.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 瑞鼎科技")
        return documents
