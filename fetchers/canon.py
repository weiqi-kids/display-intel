...
class CanonFetcher(CompanyFetcher):
    """Canon Inc. 爬蟲"""

    company_id = "canon"
    company_name = "Canon Inc."
    news_url = "https://www.canoninc.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.canoninc.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Canon Inc.")
        return documents
