...
class InnoluxFetcher(CompanyFetcher):
    """群創光電 爬蟲"""

    company_id = "innolux"
    company_name = "群創光電"
    news_url = "https://www.群創光電.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 群創光電")
        return documents
