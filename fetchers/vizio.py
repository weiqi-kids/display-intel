...
class VizioFetcher(CompanyFetcher):
    """VIZIO Holding 爬蟲"""

    company_id = "vizio"
    company_name = "VIZIO Holding"
    news_url = "https://www.vizioholding.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.vizioholding.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from VIZIO Holding")
        return documents
