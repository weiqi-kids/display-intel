...
class JdiFetcher(CompanyFetcher):
    """Japan Display 爬蟲"""

    company_id = "jdi"
    company_name = "Japan Display"
    news_url = "https://www.japandisplay.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.japandisplay.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Japan Display")
        return documents
