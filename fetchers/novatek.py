...
class NovatekFetcher(CompanyFetcher):
    """聯詠科技 爬蟲"""

    company_id = "novatek"
    company_name = "聯詠科技"
    news_url = "https://www.聯詠科技.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 聯詠科技")
        return documents
